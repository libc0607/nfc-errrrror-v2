...
__code uint8_t Prod_Des[]={                                //Produce String Descriptor
    0x1E,0x03,
    'N',0x00,'F',0x00,'C',0x00,' ',0x00,'E',0x00,'R',0x00,
    'R',0x00,'R',0x00,'R',0x00,'O',0x00,
    'R',0x00,' ',0x00,'V',0x00,'2',0x00
};
__code uint16_t Prod_DesLen = sizeof(Prod_Des);

__code uint8_t Manuf_Des[]={
    0x0E,0x03,
    'R',0x00,'h',0x00,'i',0x00,'n',0x00,'e',0x00, 'L',0x00, 'a',0x00, 'b',0x00, ' ',0x00,
};
